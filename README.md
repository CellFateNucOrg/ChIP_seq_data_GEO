Automated ChIP-seq data analysis scripts, requiring the SRR numbers of the analysis. Look for the SRR numbers of the ChIP-seq datasets which you want to use
